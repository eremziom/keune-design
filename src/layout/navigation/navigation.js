      ...
      <header>
        <nav className='navbar navbar-expand-lg'>
          <div className='container-fluid'>
            ...
            >
              <span className={ this.props.active ? 'navbar-toggler-icon white' : 'navbar-toggler-icon'}>
              </span>
            </button>
            <div 
              className={`collapse navbar-collapse ${this.props.active ? 'menuWhite' : 'menuBlack'}`} 
